...
export function BackgroundGlow({
  ...
  const glowStyles = {
    primary: {
      light: "radial-gradient(ellipse 80% 50% at 50% 0%, hsl(var(--primary) / 0.15) 0%, transparent 70%)",
      dark: "radial-gradient(ellipse 80% 50% at 50% 0%, hsl(var(--primary) / 0.1) 0%, transparent 70%)",
    },
    warm: {
      light: "radial-gradient(ellipse 60% 40% at 50% 20%, #FFF991 0%, transparent 60%)",
      dark: "radial-gradient(ellipse 60% 40% at 50% 20%, rgba(255, 249, 145, 0.15) 0%, transparent 60%)",
    },
    cool: {
      light: "radial-gradient(ellipse 60% 40% at 50% 20%, #91D5FF 0%, transparent 60%)",
  ...
  return (
    <div className={cn("relative min-h-screen w-full", className)}>
      {/* Light mode glow */}
      <div
        className="pointer-events-none absolute inset-0 z-0 dark:opacity-0 transition-opacity duration-300"
        style={{
      ...
      {/* Dark mode glow */}
      <div
        className="pointer-events-none absolute inset-0 z-0 opacity-0 dark:opacity-100 transition-opacity duration-300"
        style={{
